...
- Describe what happens when a user types a URL and presses Enter.
...
- Internet Basics (DNS, TCP/IP, TLS)
- The Browser
- Client-Server Architecture
- HTTP Overview (introduction only)
- Web Architecture
- Tech Stacks
- Databases Overview
- Version Control
...
- [Google — How DNS Works](https://developers.google.com/speed/public-dns/docs/intro)
